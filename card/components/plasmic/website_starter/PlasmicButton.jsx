...
import sty from "./PlasmicButton.module.css"; // plasmic-import: AJxG9yyH9nd7/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: YAYsAdRo-qGD/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: NaYvZ9WL-yq3/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__dKypV)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__skce6)}
                role={"img"}
              />
            ),
